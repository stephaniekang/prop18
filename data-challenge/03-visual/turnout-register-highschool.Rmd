---
title: "HS Registration and Voter Turnout/Registration Plot"
author: "Team Voteen"
date: "10/4/2020"
...
## Subset states that have laws facilitating high school voter registration
states_hs <- c("CA", "TX", "NY", "PA", "IL", "OH", "NC", "GA", "MA", "CO",
            "MN", "MO", "IN", "LA", "TN", "KY", "SC", "IA", "ME", "WV",
            "MT", "RI", "HI", "MS")
```
...
plot <- ggplot(bind_rows(youth_vote_16 %>% mutate(df = "Election Year 2016"),
  ...
  geom_point(mapping=aes(x=register, y=turnout, 
                         color = ifelse(state_code %in% states_hs, 
                                        "States with High School \nVoter Registration Laws", 
                                        "States Without"), 
                         text=paste('State: ', state_code)), size = 3) +
  # Specify colors for points
  scale_color_manual(name="",
                     values=c("lightgoldenrod","darkgray"),
                     labels=c("Yes","No")) + 
